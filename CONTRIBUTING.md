...
* If the problem started happening recently, **can you reproduce the problem in an older version of Dependencies-Injector-Pure-Swift ?** What's the most recent version in which the problem doesn't happen? You can download older versions of Dependencies-Injector-Pure-Swift from [the releases page](https://github.com/digipolitan/fastlane-ios-framework/releases).
...
#### Template For Submitting Bug Reports
    ...
    **Fastlane-ios-framework version:** [Enter dependencies-injector-pure-swift version here]
